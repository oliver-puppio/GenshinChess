...
![image](https://github.com/user-attachments/assets/d8d2abfd-6e62-4fe9-8170-aa5352024290)
![image](https://github.com/user-attachments/assets/af0b2a09-9b72-47fb-829c-b1a48cdfb604)
![image](https://github.com/user-attachments/assets/2b1eb125-5527-4333-9b4f-89d069beab1e)
![image](https://github.com/user-attachments/assets/7c924f36-6489-49a2-991c-3cd4d15d2551)
...
![image](https://github.com/user-attachments/assets/54a8777e-8109-4538-b463-976a979bbef2)
...
![image](https://github.com/user-attachments/assets/82555f45-47d6-4ed0-ab3b-523ee5a3c36a)


### 3.3  系统线程设计
本游戏需要实时和玩家的操作互动，也使用了大量动画技术。我们采用多线程技术实现这些功能。使用线程的有游戏界面类、动画面板类、防御塔类、怪物类、怪物产生控制类。为了实现重新开始和暂停控制，我们也使用了玩家对象作为锁机制，控制所有线程的运行。

![image](https://github.com/user-attachments/assets/789e88d0-af12-4786-a2f9-8b8187151643)
...
![image](https://github.com/user-attachments/assets/ba28ebe4-5cd3-4622-9b5b-9bf352a8d0d0)
![image](https://github.com/user-attachments/assets/44d4739d-b1e5-4974-8516-e06af09ec090)

### 3.5 接口和包

![image](https://github.com/user-attachments/assets/c0544802-7656-4d1d-aac2-73845100ae7b)
...
![image](https://github.com/user-attachments/assets/f5be76aa-99fa-489e-9db1-3fb38bc8fae4)
